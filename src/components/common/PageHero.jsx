...
export const PageHero = ({ badge, title, subtitle, breadcrumb = 'Page' }) => {
  return (
    <section className="relative pt-32 sm:pt-36 lg:pt-40 pb-16 sm:pb-20 overflow-hidden bg-gradient-to-b from-[#05070D] via-[#0D162B] to-[#05070D] border-b border-slate-800/80">
      ...
      <Container className="relative z-10 text-center max-w-4xl mx-auto space-y-5">
